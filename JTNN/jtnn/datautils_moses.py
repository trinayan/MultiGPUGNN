...
class JTNNDatasetMoses(Dataset):
    def __init__(self, data, vocab, training=True):
        print('Loading data...')
        data_file = '/home/trinayan/gnn_bench/JTNN/jtnn/moses_data/train.txt'
        with open(data_file) as f:
            self.data = [line.strip("\r\n ").split()[0] for line in f]
        self.vocab_file = '/home/trinayan/gnn_bench/JTNN/jtnn/moses_data/vocab.txt'
